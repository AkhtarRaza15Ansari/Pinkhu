 ...
 */
public class MedsShop extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_meds_shop, container, false);
        name = SearchPageShop.name;
        city = SearchPageShop.city;
        state = SearchPageShop.state;
        locality = SearchPageShop.locality;
        Log.d("name", name);
    ...
    public class Type extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                {
                    json_response = dumpclass.getSortedDataList("4",name,locality,city,state);
                }
                else if(MainActivity.number ==2)
                {
                    json_response = dumpclass.getSortedDataListLocation("4",name,locality,city,state);
                } else if(MainActivity.number ==3)
                {
                    json_response = dumpclass.getSortedDataListRatings("4",name,locality,city,state);
                }
                else{
                    json_response = dumpclass.getDataList("4",name,locality,city,state);
                }
