...
public class SearchPageNew extends AppCompatActivity {
    ViewPager viewPager;
    TabLayout tabLayout;
    static String name = "";
    String page = "";
    ...
    private void setupViewPager(ViewPager viewPager) {
            ...
            adapter.addFragment(new MedsCon(), "Hospital");
            adapter.addFragment(new MedsCon2(), "Doctors");
            adapter.addFragment(new MedsCon3(), "Clinics");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(SearchPageNew.this,SearchPage.class);
