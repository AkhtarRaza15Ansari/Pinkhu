 ...
 */
public class MedsRental extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_meds_rental, container, false);
        name = SearchPageRentals.name;
        city = SearchPageRentals.city;
        state = SearchPageRentals.state;
        locality = SearchPageRentals.locality;
        Log.d("name", name);
    ...
    public class Type extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                {
                    json_response = dumpclass.getSortedDataList("5",name,locality,city,state);
                }
                else if(MainActivity.number ==2)
                {
                    json_response = dumpclass.getSortedDataListLocation("5",name,locality,city,state);
                } else if(MainActivity.number ==3)
                {
                    json_response = dumpclass.getSortedDataListRatings("5",name,locality,city,state);
                }
                else{
                    json_response = dumpclass.getDataList("5",name,locality,city,state);
                }
