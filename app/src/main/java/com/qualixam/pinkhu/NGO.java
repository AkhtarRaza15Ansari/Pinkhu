 ...
 */
public class NGO extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name = SearchPageNGO.name;
        city = SearchPageNGO.city;
        state = SearchPageNGO.state;
        locality = SearchPageNGO.locality;
    ...
    public class Type extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                {
                    json_response = dumpclass.getSortedDataList("1",name,locality,city,state);
                    MainActivity.number = 0;
                }
                else if(MainActivity.number ==2)
                {
                    json_response = dumpclass.getSortedDataListLocation("1",name,locality,city,state);
                    MainActivity.number = 0;
                } else if(MainActivity.number ==3)
                {
                    json_response = dumpclass.getSortedDataListRatings("1",name,locality,city,state);
                    MainActivity.number = 0;
                }
                else{
                    json_response = dumpclass.getDataList("1",name,locality,city,state);
                }
