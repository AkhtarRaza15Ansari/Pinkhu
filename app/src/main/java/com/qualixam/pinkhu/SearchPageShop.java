...
public class SearchPageShop extends AppCompatActivity {
    ViewPager viewPager;
    TabLayout tabLayout;
    static String name = "";
    String page = "";
    ...
    private void setupViewPager(ViewPager viewPager) {
            ...
            adapter.addFragment(new MedsShop(), "MedsShop");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(SearchPageShop.this,SearchPage.class);
