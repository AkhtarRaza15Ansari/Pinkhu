 ...
 */
public class MedBanks extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_med_banks, container, false);
        name = SearchPageBanks.name;
        city = SearchPageBanks.city;
        state = SearchPageBanks.state;
        locality = SearchPageBanks.locality;
        Log.d("name", name);
    ...
    public class Type extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                {
                    json_response = dumpclass.getSortedDataList("3",name,locality,city,state);
                }
                ...
                {
                    json_response = dumpclass.getSortedDataListRatings("3",name,locality,city,state);
                }
                else{
                    json_response = dumpclass.getDataList("3",name,locality,city,state);
                }
