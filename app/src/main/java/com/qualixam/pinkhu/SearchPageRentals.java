...
public class SearchPageRentals extends AppCompatActivity {
    ViewPager viewPager;
    TabLayout tabLayout;
    static String name = "";
    String page = "";
    ...
    private void setupViewPager(ViewPager viewPager) {
            ...
            adapter.addFragment(new MedsRental(), "MedsRental");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_search) {
            Intent i = new Intent(SearchPageRentals.this,SearchPage.class);
